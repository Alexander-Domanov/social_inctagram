...
import { PostImage } from '@/modules/post-modules/latest-posts-module/api/latest-posts-api'
import { useDeletePostImage } from '@/modules/post-modules/latest-posts-module/hooks/useDeletePostImage'
